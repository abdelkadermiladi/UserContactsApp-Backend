...
public class AuthenticationService {
    ...
    public ApplicationUser registerUser(String username, String password,int age,String gender,String email,int phone_number){
        ...
        return userRepository.save(new ApplicationUser(0L, username, encodedPassword,age, gender, phone_number, email,authorities));
    }
